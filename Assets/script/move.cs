...
public class move : MonoBehaviour
{
    ...
    Vector3 startP = new Vector3(-1.5f, 10.5f, 0);
    Vector3 endP = new Vector3(-12.5f, 10.5f, 0);
    ...
    Vector3 changeEndPoint(Vector3 oldEndPoint, Vector3 location)
    {
        ...
        if (distances <= 0.1f && oldEndPoint == new Vector3(-1.5f, 10.5f, 0))
        {
            PacMan.transform.SetPositionAndRotation(oldEndPoint,Quaternion.identity);
            PacMan.SetTrigger("left");
            return new Vector3(-12.5f, 10.5f, 0);
        }
        else if (distances <= 0.1f && oldEndPoint == new Vector3(-12.5f, 10.5f, 0))
        {
            PacMan.transform.SetPositionAndRotation(oldEndPoint, Quaternion.identity);
            PacMan.SetTrigger("up");
            return new Vector3(-12.5f, 14.5f, 0);
        }
        else if (distances <= 0.1f && oldEndPoint == new Vector3(-12.5f, 14.5f, 0))
        {
            PacMan.transform.SetPositionAndRotation(oldEndPoint, Quaternion.identity);
            PacMan.SetTrigger("right");
            return new Vector3(-1.5f, 14.5f, 0);
        }
        else
        {
            PacMan.transform.SetPositionAndRotation(oldEndPoint, Quaternion.identity);
            PacMan.SetTrigger("down");
            return new Vector3(-1.5f, 10.5f, 0);
        }
    }
